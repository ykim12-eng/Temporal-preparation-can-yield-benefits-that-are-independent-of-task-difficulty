...
The data is provided as a single Excel workbook. The experiment involved a manipulation with four distinct conditions: FP600/easy, FP600/hard, FP3000/easy, and FP3000/hard. The workbook contains a master summary sheet followed by individual trial-by-trial log sheets for each subject.
...
・3rd Column (e.g., C, H, M, R): Response Hand executed by the participant (1 = Left hand, 5 = Right hand)
