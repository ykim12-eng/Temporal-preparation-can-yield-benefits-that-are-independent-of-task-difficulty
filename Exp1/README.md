This repository contains the behavioral dataset (Reaction Time and Error Rates) and the preprocessed Event-Related Potential (ERP) dataset used in the study: "Exp1".
